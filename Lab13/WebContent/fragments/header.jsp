...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <form class="form-inline my-2 my-lg-0" action="./ContactFromSearchController" method="get">
                <input class="form-control mr-sm-2" type="text" placeholder="Search" name="SearchBy">
